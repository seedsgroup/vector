...
<div class="wrapper row4">
  <footer id="footer" class="hoc clear" style="padding-top: 40px !important; padding-bottom: 20px !important;">
...
<?php if($current_page == "news"){?>
  <script src="<?php echo DTABLE_JS_URL; ?>jquery.dataTables.min.js" charset="utf-8"></script>
  <script src="<?php echo DTABLE_JS_URL; ?>dataTables.bootstrap4.min.js" charset="utf-8"></script>
<?php } ?>
